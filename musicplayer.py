...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/prana/OneDrive/Desktop/songs/","")
...
def Play():
    ...
    song=f'C:/Users/prana/OneDrive/Desktop/songs/{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/prana/OneDrive/Desktop/songs/{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/prana/OneDrive/Desktop/songs/{temp}'
...
songs_list=Listbox(root,selectmode=SINGLE,bg="red",fg="white",font=('arial',15),height=12,width=47,selectbackground="gray",selectforeground="black")
